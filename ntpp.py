...
def test(params, main_stream_time_series, reply_stream_time_series, simulation_number=20):
    MAE_main = []
    prediction_main, prediction_reply = [], []
    for i in range(10):
        pred_main, pred_reply = thinning_simulation(
                simulation_number, params, main_stream_time_series, reply_stream_time_series)
        mae = mean_absolute_error(testing_main_stream, pred_main)
        prediction_main.append(pred_main)
        prediction_reply.append(pred_reply)
        MAE_main.append(mae)
